...
> Archived by DOC-002 — Issue #125.
> The detailed CI-001 phase plan is preserved for historical traceability only.
> Current CI governance and active follow-ups belong to GitHub Issues and the current CI validation documentation.
