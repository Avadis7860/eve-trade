...
Cette matrice documente les mécanismes de protection actuels et dans le pipeline CI à l'issue de **LOT-002** (Hardening Serveur & Tests de Régression API).
...
## Synthèse de Protection (LOT-002)
...
2. **Zones à risque identifiées pour les prochains lots (P1/P2)** :
   - Hardening sécurité et validation fine des flux ESI / OAuth (`LOT-003`)
   - Refactorisation et consolidation de la couche client ESI
