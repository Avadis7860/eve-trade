...
A new audit records its baseline SHA/date, verified facts, unverified historical findings, risks, actions and validation. Once superseded, move it to the archive rather than leaving competing current-state claims.
