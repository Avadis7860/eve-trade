...
MarketOrder observations remain a separate layer.
...
Fee availability is independent from lifecycle. Without fee evidence, gross disposal facts can remain available while net P&L and net ratios remain unavailable.
...
[Financial contract](../../contracts/financial.md) · [Financial validation](../../validation/financial.md) · [Financial Truth Rebase](../../roadmap/financial-truth-rebase.md)
