...
The documentation reconstruction (DOC-001) is complete and merged as PR #43. The stabilization sequence #37–#42 remains the functional foundation.
...
| E2E-001 | NEXT | Establish reproducible local OAuth/browser gate | stable auth/ESI | environment-sensitive auth | browser smoke + security/API |
| PST-001 | PLANNED | Decompose IndexedDB implementation without semantic drift | persistence contract | migration/data-loss risk | persistence + full regression |
...
| E2E-002 | PLANNED | Add critical browser workflows | E2E-001, UI-001, PST-001 as needed | false confidence from partial flows | browser suite + CI |
