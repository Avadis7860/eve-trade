...
| FIN-002-RECON | CERTIFIED / READY FOR MERGE | Reconcile and selectively reconstruct the archived Financial Truth semantic boundary against current main | current main + historical evidence | contradictory lifecycle/profitability semantics | accepted contract + domain tests + CI ownership |
