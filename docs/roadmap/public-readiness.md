...
|---|---|---|---|
| PUB-001 | IN PROGRESS | README, public status, CI badge, capabilities and known limits | accurate README on main |
...
| PUB-007 | IN PROGRESS | active-document synchronization | no stale current-state claims |
