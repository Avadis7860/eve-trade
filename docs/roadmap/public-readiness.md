...
| PUB-003 | DONE | source-code license model | explicit MIT decision + LICENSE + third-party boundary notice |
...
PUB-001 and PUB-007 are completed. PUB-003 is resolved by the published MIT license and explicit third-party boundary notice. PUB-002 remains an explicit gate before portfolio publication.
