...
- Operations is partially implemented as a product surface, and its current UX-02 gate covers keep / adjust / relocate / cancel, active-order loading/empty states, LIVE / CACHE / STALE / PARTIAL / UNKNOWN / ERROR market health semantics, failed refresh preservation, health-aware outbid filtering, refresh coordination, canonical market-source deduplication and row ↔ detail consistency.
