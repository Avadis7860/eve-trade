...
- CI-001 is now ACTIVE. CI-001A/B froze the baseline and evidence map; CI-001C hardened permissions/action pinning/runtime reproducibility; CI-001D is the active topology slice. Required-gate/change-detection/branch-protection work remains gated by later phases.
