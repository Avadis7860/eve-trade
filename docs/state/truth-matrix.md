...
| Agent context | ACTIVE ON CURRENT BRANCH | .eve-trade/context-map.json + current-work + context-integrity | test:context + CI static | [agent context](../operations/agent-context.md) | stabilize navigation/governance |
