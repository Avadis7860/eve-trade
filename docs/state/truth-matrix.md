...
| Agent context | CLOSING ON DELIVERY BRANCH / STABLE AFTER MERGE | .eve-trade/context-map.json + current-work + context-integrity + ci-scope | test:context + CI static | [agent context](../operations/agent-context.md) | lifecycle/bootstrap/routing hardening |
